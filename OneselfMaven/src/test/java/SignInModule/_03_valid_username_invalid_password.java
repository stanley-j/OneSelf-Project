...
public class _03_valid_username_invalid_password {
	...
	public static void signIn1() throws Throwable {
		...
		email.sendKeys(DataDriven.readData(3, 0, "TestData"));

		WebElement password = driver.findElement(By.xpath("//input[@placeholder='Enter your password']"));
		password.sendKeys(DataDriven.readData(3, 1, "TestData"));
    ...
    browserLaunch();
    signIn1();
    System.out.println("Successfully throw an exception with valid username and invalid password like #invalid username or password");
